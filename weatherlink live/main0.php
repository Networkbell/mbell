...
$parameters = array(
  "api-key" => "987654321",
  "api-secret" => "ABC123",
  "station-id" => "2", // this is an example station ID, you need to replace it with your real station ID which you can retrieve by making a call to the /stations API endpoint
  "t" => time()
);
