...
*/
$parameters = array(
  "api-key" => "dyqtrpjgglfy1x3nsqpvitiretmapdkx",
  "api-secret" => "nnqnyozxk5xtqtqi3hty0lkbicvijgtj",
  "station-id" => "112518", // this is an example station ID, you need to replace it with your real station ID which you can retrieve by making a call to the /stations API endpoint
  "t" => time()
);
